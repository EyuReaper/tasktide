...
const Chatbot = () => {
    const [messages, setMessages] = useState([
        {sender:"bot", text:"welcome to TaskTide. How can I help you today?"},
    ]);
    ...
    return (
        <div className="fixed bottom-4 right-4 bg-white p-4 shadow-lg w-80">
            <div className="overflow-y-auto h-60 border-b-2 mb-2">
                ...
                <span className={`inline-block px-4 py-2 rounded ${msg.sender === "bot" ? "bg-gray-200" : "bg-blue-500 text-white"}`}>
                    {msg.text}
                    </span>
                    </div>
                ))}
